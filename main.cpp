...
enum ErrorCodes { SYNC_ERR, CHECKSUM_ERR, RNM_ERR, RMV_ERR, SEND_DIR_ERR, OPEN_FILE_ERR, START_SEND_FILE_ERR, READ_FILE_ERR, SEND_CHUNK_ERR, SEND_FILE_ERR, END_SEND_FILE_ERR, CONF_ERR, NOT_EXISTING_DIR_ERR, ADD_DIR_ERR, ADD_FILE_ERR, CONF_FILE_ERR, IP_PORT_ERR, CONNECTION_ERR, AUTH_ERR, BOOST_ERR };
